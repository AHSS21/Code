...
font-size: 16px;">  </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="roads.php"><i class="fa fa-edit fa-3x"></i> Roads </a>
                    </li>	
		...
		<br>
		Officer_on_duty :<br>
		<input type="text" name="Officer_on_duty">
		<br>
        <br>
		<input type="button" onclick="submitForm();" name="save_contact" value="ADD">
            ...
            <script type="text/javascript">
                function submitForm()
                {
                    ...
                    var Officer_on_duty = $('input[name=Officer_on_duty]').val();
        
                    if(Name != '' && Length!= '' && Officer_on_duty != '')
                    {
                        var formData = {Name: Name, Length: Length , Officer_on_duty: Officer_on_duty};
                        $('#message').html('<span style="color: red">Adding User. . . please wait. . .</span>');
                        $.ajax({url: "http://localhost/AHSS/roads.php", type: 'POST', data: formData, success: function(response)
                        {
